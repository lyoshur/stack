---
title: 1.Eureka-spring-boot(2.1.8.RELEASE)+spring-cloud(Greenwich.SR3)
description: 1.Eureka
slug: 1.Eureka-spring-boot(2.1.8.RELEASE)+spring-cloud(Greenwich.SR3)
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <parent>
        ...
        <!-- 这里默认的boot版本为2.2.1.RELEASE。手动修改为2.1.8.RELEASE -->
